                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>
                                            <a href="tambah_mobil.php" class="btn btn-primary btn-rounded toggle-vis mb-8 ml-2">Tambah Data</a>
                                        </h4>
                                    </div>
                                                ...
                                                ?>
                                                    ...
                                                    <td class="text-center">
                                                        <ul class="table-controls">
                                                            <li><a href="edit_mobil.php?id_mobil=<?php echo  $row["id_mobil"]; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="flaticon-edit  p-1 br-6 mb-1"></i></a></li>
                                                            <li><a href="delete_mobil.php?id_mobil=<?php echo  $row["id_mobil"]; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="flaticon-delete  p-1 br-6 mb-1"></i></a></li>
                                                        </ul>
                                                    </td>
