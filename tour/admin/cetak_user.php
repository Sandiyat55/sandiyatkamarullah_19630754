...
<head>
    ...
    <title>Cetak User | Travel Icha </title>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <?php
                    $no = 1;
                    $query = mysqli_query($conn, "SELECT * FROM users Where not id_user='1' ORDER BY id_user DESC;");
                    ...
                    ?>
                        ...
                        ?>
                            <td class="align-center"><?php echo $row['role']; ?></td>
                        <?php } else {
                        ?>
                            <td class="align-center"><?php echo $row['role']; ?></td>
                        <?php
                        } ?>
                        <td><?php echo "<img src='../gambar/$row[gambar]' width='50' height='70' />"; ?></td>
