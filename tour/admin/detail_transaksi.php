                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-right"><?php echo number_format($data['total_harga']); ?></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-sm-12 col-12">
                                                    <a href="cetak_detail_transaksi.php?id_transaksi=<?php echo $data['id_transaksi'] ?> " class="btn btn-primary btn-rounded send-invoice mb-5 mt-4">Print Invoice</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
