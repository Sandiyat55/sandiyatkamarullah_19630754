...
<head>
    ...
    <title>Cetak struk | Travel Icha </title>
...
<body>
    ...
    <div class="widget-content-area content-section">
        <div class="row invoice-top-section">
            <div class="col-sm-6 mb-4">
                <h5 class="invoice-info-title">Struk Pesanan <?php echo $data['id_transaksi'] ?></h5>
    ...
    <div class="row mt-3 mb-1">
        <div class="col-md-6 col-sm-6 invoice-from">
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    ...
                    <br>
                    <h5>
                        <p>Keadaan Mobil : ___________________________________ </p>
                    </h5>

                </div>
                <div class="col-12 mb-3">
                    <h5>
                        <p>Bensin Mobil : _____________________________________</p>
                    </h5>

                </div>
                <div class="col-12 mb-3">
                    <h5>
                        <p>Perlengkapan Mobil : ______________________________ </p>
                    </h5>
                ...
                <div class="col-12 mb-3">
                    ...
                    <h5>
                        ...
                        <br>
                        <p>Motor : ______________________________ </p>
                        <br>
                        <p>Stnk : ________________________________ </p>
                    </h5>
        ...
        <div class="col-md-6 col-sm-6 invoice-to text-sm-center">
            <div class="text" style="margin-top:30px">
                <center>
            ...
            <div class="row mb-5">
                ...
                <div class="col-12 mb-2">
                    ...
                    <h5>
                        <p>1. Penyewa Diwajibkan menunjukan SIM & KTP</p>
                    </h5>

                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>2. Wajib meninggalkan motor dan stnk sebagai jaminan</p>
                    </h5>

                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>3. Mobil dilarang dipindah tangankan</p>
                    </h5>
                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>4. Jika terjadi sesuatu yang tidak diinginkan seperti kecelakaan mengakibatkan kerusakan pada unit, maka perbaikan ditanggung oleh pihak penyewa</p>
                    </h5>
                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>5. Penyewa mobil tidak dalam pengaruh minuman keras & tidak ugal-ugalan dalam mengemudi</p>
                    </h5>
                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>6. keterlambatan pengembalian dikenakan biaya tambahan</p>
                    </h5>
                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>7. Pengambilan unit harap mendatangi kantor dengan membawa SIM, KTP, STNK, Motor dan Menunjukan serta mengirimkan struk pesanan ini ke admin</p>
                    </h5>
                </div>
