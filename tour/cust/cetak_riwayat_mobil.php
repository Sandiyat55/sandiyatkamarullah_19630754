...
$query1 = mysqli_query($conn, "SELECT transaksi.*, mobil.id_mobil, mobil.nama_mobil, users.id_user, users.username FROM transaksi INNER JOIN mobil ON transaksi.id_mobil = mobil.id_mobil INNER Join users ON transaksi.id_user = users.id_user where jenis_transaksi = 'mobil' and users.id_user='$id_user' ORDER BY id_transaksi DESC;");
...
<head>
    ...
    <title>Cetak Sewa Mobil | Travel Icha </title>
...
<body>
    ...
    <center>
        <h3><b>Data Sewa Mobil <?php echo $row['username'] ?></b></h3>
    </center>
