        ...
        <div class="col-md-6 col-sm-6 invoice-to text-sm-center">
            ...
            <div class="row mb-5">
                ...
                <div class="col-12 mb-2">
                    ...
                    <h5>
                        <p>1. Pemilihan no kursi berdasarkan urutan booking</p>
                    </h5>

                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>2. tour akan berjalan jika jumlah peserta mencapai 12 orang</p>
                    </h5>

                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>3. jika jumlah peserta final kurang dari 12 orang maka akan di adakan musyawarah untuk penyesuaian harga</p>
                    </h5>
                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>4. pembatalan akan dikenakan biaya penuh</p>
                    </h5>
                </div>
                <div class="col-12 mb-2">
                    <h5>
                        <p>5. teknis keberangkatan akan diinfokan oleh admin</p>
                    </h5>
                </div>
