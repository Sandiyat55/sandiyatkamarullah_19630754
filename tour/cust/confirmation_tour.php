...
$sql = mysqli_query($conn, "SELECT transaksi.*, users.id_user, users.username, users.email, users.no_hp,users.alamat,users.no_ktp, wisata.id_wisata, wisata.nama ,wisata.harga FROM transaksi INNER JOIN users ON transaksi.id_user = users.id_user INNER JOIN wisata ON transaksi.id_wisata = wisata.id_wisata where transaksi.id_transaksi='$id_transaksi'");
                ...
                <div class="payment-book">
                    <div class="booking-box">
                        ...
                        <div class="booking-border d-flex">
                            ...
                            <a href="cetak_struk_transaksi.php?id_transaksi=<?php echo  $row["id_transaksi"]; ?>" target="_blank" class="nir-btn-black"><i class="fa fa-print"></i> Cetak</a>
                        </div>
                    </div>
                </div>
            </div>
